...
void x86emu_check_mem_access (u32 __unused dummy)
{
    /*  check bounds, etc */
}

void x86emu_check_data_access (uint __unused dummy1, uint __unused dummy2)
{
    /*  check bounds, etc */
}
...
int parse_line (char *s, int *ps, int *n)
#else
int parse_line (char * __unused s, int * __unused ps, int * __unused n)
#endif
{
#if 0
    int cmd;
