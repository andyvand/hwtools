 ...
 * ****************************************************************************/
static void x86emuOp2_invd(u8 __unused op2)
{
  START_OF_INSTR();
  DECODE_PRINTF("INVD\n");
  TRACE_AND_STEP();
 ...
 * ****************************************************************************/
static void x86emuOp2_wbinvd(u8 __unused op2)
{
  START_OF_INSTR();
 ...
 * ****************************************************************************/
static void x86emuOp2_wrmsr(u8  __unused op2)
{
 ...
 * ****************************************************************************/
static void x86emuOp2_rdmsr(u8 __unused op2)
{
